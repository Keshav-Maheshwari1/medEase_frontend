...
import labtech from '../images/labtech.jpeg'
    ...
    <div className='labtest-main'>
      <nav className='nav-items'>
        ...
        <div className='nav-links'>
          ...
          <span className='nav-group-item' onClick={handleLabTestClick}><span className='inside-labtest'>Lab Test</span>
          </span>
        </div>
      ...
      <div className="main-search">
        ...
        <select id="main-search-test" name="dropdownSize" >
          <option value="">Search for Test</option>
      ...
      <div className="labtest-front">
        <div className="main-content">
          <h1 className='main-content-heading'>Precision Health Starts Here: Reliable Medical Testing You Can Trust.</h1>
          <p className='main-content-detail'>Experience confidence in your health journey. Our reliable medical testing ensures precise results, complemented by personalized care. Trust us for accurate insights and unwavering support, empowering you to make informed decisions for a healthier, happier life.</p>
        </div>
        <div className="labTech">
          <img src={labtech} alt="" />
        </div>
      </div>
      <h1 className='labtest-headline'>Find Test By Health Concern</h1>
